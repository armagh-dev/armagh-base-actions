...
class TestAction < Test::Unit::TestCase
  ...
  def test_update_document
    ...
    content = 'content'
    meta = 'meta'
    @caller.expects(:update_document).with(id, content, meta)
    a.update_document(id, content, meta)
  end
  ...
  def test_insert_document
    ...
    content = 'content'
    meta = 'meta'
    @caller.expects(:insert_document).with(nil, content, meta)
    a.insert_document(content, meta)

    @caller.expects(:insert_document).with(id, content, meta)
    a.insert_document(id, content, meta)
  end
  ...
  def test_insert_or_update_document
    ...
    content = 'content'
    meta = 'meta'
    @caller.expects(:insert_or_update_document).with(id, content, meta)
    a.insert_or_update_document(id, content, meta)
  end
end
